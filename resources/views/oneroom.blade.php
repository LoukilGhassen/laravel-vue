    ...
    <div class="row py-3">
        ...
        <div class="col-2">
            <div class="input-group date" id="datepicker1">
                <input autocomplete="off" type="text" class="form-control" id="date" placeholder="From" name="time_from" id="time_from" value="{{old('time_from')}}"/>
        ...
        <div class="col-2">
            <div class="input-group date" id="datepicker2">
                <input autocomplete="off" type="text" class="form-control" id="date"  placeholder="To" name="time_to" id="time_to"  value="{{old('time_to')}}"/>
                <span class="input-group-append">
